...
Claude SEO is a Tier 4 SEO analysis skill with 28 sub-skills (24 core + 1 orchestrator +
...
```
skills/                    # 28 sub-skills (auto-discovered)
  ...
  seo-semrush/             # Semrush domain/keyword/backlink analytics (MCP, no local key)
